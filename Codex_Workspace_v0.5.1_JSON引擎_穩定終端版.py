...
<div class="app">
<header class="top">
<button id="btnHistory" class="iconbtn">☰</button><div class="brand"><div class="brandmark">✦</div><div><h1>Codex Workspace</h1><small>JSON 引擎 · v<span id="version">0.5.1</span></small></div></div>
